...
public class Personas {
    ...
    @NotNull(message = "El primer nombre no debe estar vacío")
    ...
    @NotNull(message = "El primer apellido no debe estar vacío")
    ...
    @Column( unique = true )
    @NotNull(message = "La identificación no debe estar vacía")
